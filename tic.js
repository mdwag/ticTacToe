...
topRight.addEventListener("click", function () { testBoy(this)});
topMid.addEventListener("click", function () { testBoy(this)});
topLeft.addEventListener("click", function () { testBoy(this)});
midLeft.addEventListener("click", function () { testBoy(this)});
midMid.addEventListener("click", function () { testBoy(this)});
midRight.addEventListener("click", function () { testBoy(this)});
bottomLeft.addEventListener("click", function () { testBoy(this)});
bottomMid.addEventListener("click", function () { testBoy(this)});
bottomRight.addEventListener("click", function () { testBoy(this)});
